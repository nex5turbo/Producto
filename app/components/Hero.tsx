...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section className="relative pt-40 pb-16 lg:pt-48 lg:pb-24 overflow-hidden" id="home">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              {/* Decorative elements */}
              <div className="absolute -top-6 -right-6 w-24 h-24 bg-accent/10 rounded-full filter blur-xl" aria-hidden="true"></div>
              <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-secondary/10 rounded-full filter blur-xl" aria-hidden="true"></div>
            </motion.div>
          </div>
        </div>
        
        {/* Background decoration */}
        <div className="absolute top-1/4 right-0 w-64 h-64 bg-secondary/5 rounded-full filter blur-3xl" aria-hidden="true"></div>
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-accent/5 rounded-full filter blur-3xl" aria-hidden="true"></div>
      </section>
    </>
  );
} 